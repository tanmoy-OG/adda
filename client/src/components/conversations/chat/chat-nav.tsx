  ...
  return (
    <div className="navbar z-10 flex justify-between pl-10 shadow hover:cursor-default">
      ...
      <details className="dropdown dropdown-end">
        <summary className="btn btn-ghost hover:bg-base-100 active:bg-info size-10 min-h-0 p-2 transition-all hover:scale-110 active:transition-all">
          <ThreeDotSvg />
        </summary>
        <ul className="menu dropdown-content rounded-box bg-base-100 z-[1] w-52 gap-2 p-2 shadow">
          <li>
